...
public class NGSIToJson extends AbstractProcessor {
  ...
  public static final PropertyDescriptor ATTRIBUTE = new PropertyDescriptor.Builder()
      .name("Attributes").displayName("Comma separted attribute")
      .description("Comma separted attribute or fields to add in Json")
      .required(false)
  ...
  public void onTrigger(final ProcessContext context, final ProcessSession session)
    ...
    String attributes = context.getProperty(ATTRIBUTE).getValue();
    ...
    flowFile = session.write(flowFile, new OutputStreamCallback() {
      ...
      public void process(OutputStream out) throws IOException {
          out.write(partValue.get().getBytes());
      }
  });
